...
function MeetingPage() {
    ...
    const { message, loading, nativeBalance } = useBalances();

    const native = nativeBalance && Number(nativeBalance.balance) > 0 ? formatBalance(nativeBalance.balance) : 0;
        ...
        <main className={styles.main}>
            <div className={styles.center}>
                <div>
                    ...
                    {
                        message ? message : loading ? <div>Your balance is loading...</div>
